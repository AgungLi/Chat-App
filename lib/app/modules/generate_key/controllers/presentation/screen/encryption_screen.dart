...
import 'package:chatapp/app/modules/generate_key/controllers/business_logic/encryption_bloc/encryption_bloc.dart';
import 'package:chatapp/app/modules/generate_key/controllers/business_logic/key_manager_bloc/keysmanager_bloc.dart';
          ...
          child: Column(
            children: [
              ...
              RaisedButton(
                child: Text("Save Key"),
                onPressed: () {
                  var privateKey = rsa.encodePrivateKeyToPemPKCS1(
                      widget._asymmetricKeyPair.privateKey as RSAPrivateKey);
                  var publicKey = rsa.encodePublicKeyToPemPKCS1(
                      widget._asymmetricKeyPair.publicKey as RSAPublicKey);

                  authC.updateKeyPairs(privateKey, publicKey);
                },
              ),
            ],
          ),
